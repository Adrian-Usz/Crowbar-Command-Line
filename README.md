Forked version to also include compiling from command line
...
Also if you want to compile it yourself, seems to compile fine with Any CPU option with visual studio 2022 preview
